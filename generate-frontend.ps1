...
if (-not (Test-Path $envFile)) {
    Write-Host "❌ .env file not found. Please run 'azd up' first." -ForegroundColor Red
    exit 1
}
...
Write-Host "✅ Frontend generated: nbk-frontend.html" -ForegroundColor Green
Write-Host ""
...
Write-Host "   3. Hold '🎤 Hold to Speak' button and speak" -ForegroundColor White
